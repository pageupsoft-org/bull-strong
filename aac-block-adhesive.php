    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 lg:gap-10 gap-0">
        ...
        <div class="lg:col-span-8">
            ...
            <p class="text-brandGrayText mb-6 text-sm md:text-base md:w-96">
                High Strength Masonry Mortar for Block Work
            </p>
            ...
            <div class="mb-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-2 p-4 text-md rounded-lg text-brandGrayText bg-[#F3F3F3]">
                    <div class="flex gap-3 p-2">
                        ...
                        <p>
                            Factory prepared polymer modified masonry mortar.
                        </p>
                    </div>
                    <div class="flex gap-3 p-2">
                        <i class="fa-regular fa-circle-check text-[#b01620] mt-1"></i>
                        <p>
                            Designed for thin bed block construction.
                        </p>
                    </div>
                    <div class="flex gap-3 p-2">
                        <i class="fa-regular fa-circle-check text-[#b01620] mt-1"></i>
                        <p>
                            Provides high bonding strength and durability.
                        </p>
                    </div>
                    <div class="flex gap-3 p-2">
                        <i class="fa-regular fa-circle-check text-[#b01620] mt-1"></i>
                        <p>Allows smooth application and easy spreading.</p>
                    </div>
                    <div class="flex gap-3 p-2">
                        <i class="fa-regular fa-circle-check text-[#b01620] mt-1"></i>
                        <p>Suitable for layers up to 12 mm thickness for surface smoothing.</p>
                    </div>
                    <div class="flex gap-3 p-2">
                        <i class="fa-regular fa-circle-check text-[#b01620] mt-1"></i>
                        <p>
                            Ideal for AAC blocks, fly ash bricks, and lightweight masonry units.
                        </p>
                    </div>
                    <div class="flex gap-3 p-2">
                        <i class="fa-regular fa-circle-check text-[#b01620] mt-1"></i>
                    ...
                    <table class="w-full text-md text-left">
                        ...
                        <tbody class="divide-y divide-gray-200 bg-[#F9F9F9]">
                            <tr class="bg-brandLightGray">
                                ...
                                <td class="px-6 py-4 text-brandGrayText">Polymer Modified Masonry Mortar</td>
                            </tr>
                            <tr class="bg-[#F3F3F3]">
                                <td class="px-6 py-4 font-medium text-brandDark">Application</td>
                                <td class="px-6 py-4 text-brandGrayText">AAC Block & Lightweight Block Laying</td>
                            </tr>
                            <tr class="bg-brandLightGray">
                                <td class="px-6 py-4 font-medium text-brandDark">Bed Thickness</td>
                                <td class="px-6 py-4 text-brandGrayText">2–3 mm</td>
                            </tr>
                            <tr class="bg-[#F3F3F3]">
                                <td class="px-6 py-4 font-medium text-brandDark">Layer Thickness</td>
                                <td class="px-6 py-4 text-brandGrayText">Up to 12 mm (for smoothing surfaces)</td>
                            </tr>
                            <tr class="bg-brandLightGray">
                                <td class="px-6 py-4 font-medium text-brandDark">Water Mixing Ratio</td>
                                <td class="px-6 py-4 text-brandGrayText">25–30% water by weight</td>
                            </tr>
                            <tr class="bg-[#F3F3F3]">
                            ...
                            <tr class="bg-brandLightGray">
                                ...
                                <td class="px-6 py-4 text-brandGrayText">
                                    Approx. 127 sq.ft per 40 kg bag at 2 mm thickness
                                </td>
                            </tr>
                            <tr class="bg-[#F3F3F3]">
                                <td class="px-6 py-4 font-medium text-brandDark">Block Size Reference</td>
                                <td class="px-6 py-4 text-brandGrayText">
                                    600 × 200 × 100 mm
                                </td>
                            </tr>
            ...
            <div class="mb-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-2 p-4 text-md rounded-lg text-brandGrayText bg-white border-2 border-[#F3F3F3]">
                    ...
                    <div class="flex gap-3 p-2">
                        <i class="fa-regular fa-circle-check text-[#b01620] mt-1"></i>
                        <p>Aerated Lightweight Concrete Blocks</p>
                    </div>
                    <div class="flex gap-3 p-2">
                        <i class="fa-regular fa-circle-check text-[#b01620] mt-1"></i>
                        <p>
            ...
            <div class="mb-12">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    <div class="bg-brandLightGray border border-gray-200 rounded-lg md:p-6 p-3 text-center flex flex-col items-center justify-center">
                        ...
                        <h3 class="font-bold text-md mb-1"> Mortar Mixing</h3>
                        <p class="text-sm text-brandGrayText">
                            In a bucket, mix Bull Strong AAC Block Adhesive with 25–30% clean water to achieve a smooth mortar consistency.
                        </p>
                    </div>
                    <div class="bg-brandLightGray border border-gray-200 rounded-lg md:p-6 p-3 text-center flex flex-col items-center justify-center">
                        ...
                        <p class="text-sm text-brandGrayText">Allow the mixed mortar to stand for approximately 5 minutes before use.</p>
                    </div>
                    <div class="bg-brandLightGray border border-gray-200 rounded-lg md:p-6 p-3 text-center flex flex-col items-center justify-center">
                        ...
                        <p class="text-sm text-brandGrayText">Clean the blocks using a brush to remove dust and foreign particles before application.</p>
                    </div>
                    <div class="bg-brandLightGray border border-gray-200 rounded-lg md:p-6 p-3 text-center flex flex-col items-center justify-center">
                        ...
                        <p class="text-sm text-brandGrayText">Spread the mortar evenly on the block surfaces to maintain a bond thickness of 2–3 mm.</p>
                    </div>
                    <div class="bg-brandLightGray border border-gray-200 rounded-lg md:p-6 p-3 text-center flex flex-col items-center justify-center">
                        <div class="w-10 h-10 rounded-full bg-brandRed text-white flex items-center justify-center font-bold mb-3 shadow-md">5</div>
                        <h3 class="font-bold text-md mb-1">Block Placement & Alignment</h3>
                        <p class="text-sm text-brandGrayText">Place the block carefully and ensure proper alignment and jointing, removing any air gaps between blocks.</p>
                    </div>
                    <div class="bg-brandLightGray border border-gray-200 rounded-lg md:p-6 p-3 text-center flex flex-col items-center justify-center">
                        ...
                        <p class="text-sm text-brandGrayText">After block placement, do not disturb the masonry for at least 24 hours to ensure proper bonding and strength.</p>
                    </div>
                </div>
            </div>
                    ...
                    <form action="send-mail.php" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="product_name" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm focus:outline-none focus:border-brandRed">
                                ...
                                <option value="aac-block" selected>Bull Strong AAC Block</option>
...
<section class="text-white py-16 relative overflow-hidden bg-cover bg-center"
    ...
    <div class="max-w-4xl mx-auto px-4 relative z-10 text-center">
        <h2 class="text-3xl md:text-4xl font-bold mb-4">
            Need Help with Block Masonry Solutions?
        </h2>
        <p class="text-gray-300 mb-8 max-w-2xl mx-auto">Our experts can guide you in selecting the right adhesive and application method for your project.</p>
