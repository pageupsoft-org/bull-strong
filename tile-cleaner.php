    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 lg:gap-10 gap-0">
        ...
        <div class="lg:col-span-8">
            ...
            <div class="bg-gray-100 rounded-lg overflow-hidden mb-8 h-64 md:h-96 flex items-center justify-center">
                <img src="images/product-detail/tile-cleaner.jpg" alt="Bull Strong Tile Cleaner" class="object-cover w-full h-full border border-gray-100">
            </div>
...
<section class="text-white py-16 relative overflow-hidden bg-cover bg-center"
    ...
    <div class="max-w-4xl mx-auto px-4 relative z-10 text-center">
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-4">
            <a href="contact-us.php" class="bg-white text-brandDark font-medium px-8 py-3 rounded hover:bg-gray-100 transition">Talk to an Expert </a>
