...
<main class="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div class="lg:col-span-4 space-y-6">
            ...
            <div class="bg-red-50 rounded-lg p-6 border border-red-100 shadow-sm hidden">
            ...
            <div class="bg-white rounded-lg p-6 border-2 border-red-100 shadow-sm">
                ...
                <form action="send-mail.php" method="POST" class="space-y-4">
                    ...
                    <div>
                        <label class="block text-xs font-medium text-brandDark mb-1 uppercase">Project Type</label>
                    ...
                    <div>
                        <label class="block text-xs font-medium text-brandDark mb-1 uppercase">Product</label>
                        <select name="product_name" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm focus:outline-none focus:border-brandRed">
                            <option value="tile-adhesive" selected>Tile Adhesive</option>
                    ...
                    <div>
                        <label class="block text-xs font-medium text-brandDark mb-1 uppercase">Project Details / Message</label>
                        <textarea name="message" rows="4" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm focus:outline-none focus:border-brandRed" placeholder="Enter your project details or message..."></textarea>
                    </div>
...
<section class="bg-brandDark text-white py-16 relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-4 relative z-10 text-center">
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-4">
            <a href="contact-us.php" class="bg-white text-brandDark font-medium px-8 py-3 rounded hover:bg-gray-100 transition">Contact Us</a>
