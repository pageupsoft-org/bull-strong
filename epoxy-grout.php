    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 lg:gap-10 gap-0">
        ...
        <div class="lg:col-span-8">
            ...
            <div class="bg-gray-100 rounded-lg overflow-hidden mb-8 h-64 md:h-96 flex items-center justify-center">
                <img src="images/product-detail/epoxy-grout-part-2.jpg" alt="Bull Strong Epoxy Grout" class="object-cover w-full h-full border border-gray-100">
            </div>
            <!-- Product Title & Quick Specs -->
            <h1 class="text-3xl md:text-4xl font-bold mb-2">
                Bull Strong
                <span class="text-brandRed"> Epoxy Grout</span>
            </h1>
            <p class="text-brandGrayText mb-6 text-sm md:text-base md:w-96">
                Stain-Free High Performance Tile & Stone Grout
            </p>
            ...
            <div class="mb-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-2 p-4 text-md rounded-lg text-brandGrayText bg-[#F3F3F3]">
                    <div class="flex gap-3 p-2">
                        ...
                        <p>Three-component epoxy grout system (Part A, B & C).</p>
                    </div>
                    <div class="flex gap-3 p-2">
                        <i class="fa-regular fa-circle-check text-[#b01620] mt-1"></i>
                        <p>
                    ...
                    <div class="flex gap-3 p-2">
                        <i class="fa-regular fa-circle-check text-[#b01620] mt-1"></i>
                        <p>
                            Impervious and non-porous surface after curing.
                        </p>
                    </div>
                    <div class="flex gap-3 p-2">
                        <i class="fa-regular fa-circle-check text-[#b01620] mt-1"></i>
                        <p>Highly resistant to chemicals, stains, abrasion, and impact.</p>
                    </div>
                    <div class="flex gap-3 p-2">
                        <i class="fa-regular fa-circle-check text-[#b01620] mt-1"></i>
                        <p>Maintains hygiene in sensitive environments.</p>
                    </div>
                    <div class="flex gap-3 p-2">
                        <i class="fa-regular fa-circle-check text-[#b01620] mt-1"></i>
                        <p>
                            Suitable for ceramic tiles, vitrified tiles, marble, and natural stones.
                        </p>
                    </div>
                    <div class="flex gap-3 p-2">
                        <i class="fa-regular fa-circle-check text-[#b01620] mt-1"></i>
                        <p>
                            Ideal for high traffic and stain-prone areas.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <table class="w-full text-md text-left">
                        ...
                        <tbody class="divide-y divide-gray-200 bg-[#F9F9F9]">
                            <tr class="bg-brandLightGray">
                                ...
                                <td class="px-6 py-4 text-brandGrayText">Epoxy Resin Based Tile Grout</td>
                            </tr>
                            <tr class="bg-[#F3F3F3]">
                                <td class="px-6 py-4 font-medium text-brandDark">Components</td>
                                <td class="px-6 py-4 text-brandGrayText">Part A (Resin), Part B (Hardener), Part C (Colored Filler Powder)</td>
                            </tr>
                            <tr class="bg-brandLightGray">
                                <td class="px-6 py-4 font-medium text-brandDark">Consistency</td>
                                <td class="px-6 py-4 text-brandGrayText">Smooth Creamy Mix</td>
                            </tr>
                            <tr class="bg-[#F3F3F3]">
                                <td class="px-6 py-4 font-medium text-brandDark">Chemical Resistance</td>
                                <td class="px-6 py-4 text-brandGrayText">Excellent</td>
                            </tr>
                            <tr class="bg-brandLightGray">
                                <td class="px-6 py-4 font-medium text-brandDark">Water Resistance</td>
                                <td class="px-6 py-4 text-brandGrayText">Impervious / Non-Porous</td>
                            </tr>
                            <tr class="bg-[#F3F3F3]">
            ...
            <div class="mb-12">
                <div class="flex items-center gap-3 mb-4">
                    <div class="w-6 h-1 bg-[#b01620]"></div>
                    <h2 class="text-2xl font-semibold">Available Grout Shades</h2>
                </div>
                <p class="text-brandGrayText text-sm md:text-base mb-8 max-w-2xl">
                    Bull Strong Epoxy Grout is available in more than 36 attractive colours to match different tile designs and interior styles.
                </p>
                <div class="hidden grid grid-cols-3 sm:grid-cols-4 md:grid-cols-8 xl:grid-cols-10 gap-y-4 md:gap-y-8 gap-x-2 md:gap-x-4">
                    <div class="flex flex-col items-center gap-2 group cursor-pointer">
                        <div class="w-14 h-12 rounded-md shadow-sm border border-gray-200 transition duration-200 group-hover:shadow-md group-hover:-translate-y-1" style="background-color: #FFFFF0;"></div>
                        <span class="text-xs font-medium text-[#1F2937] text-center">Ivory</span>
                    </div>
                    <div class="flex flex-col items-center gap-2 group cursor-pointer">
                        <div class="w-14 h-12 rounded-md shadow-sm border border-gray-200 transition duration-200 group-hover:shadow-md group-hover:-translate-y-1" style="background-color: #FFFFFF;"></div>
                        <span class="text-xs font-medium text-[#1F2937] text-center">White</span>
                    </div>
                    <div class="flex flex-col items-center gap-2 group cursor-pointer">
                        <div class="w-14 h-12 rounded-md shadow-sm border border-gray-200 transition duration-200 group-hover:shadow-md group-hover:-translate-y-1" style="background-color: #5C7B91;"></div>
                        <span class="text-xs font-medium text-[#1F2937] text-center">Dolphin Blue</span>
                    </div>
                    <div class="flex flex-col items-center gap-2 group cursor-pointer">
                        <div class="w-14 h-12 rounded-md shadow-sm border border-gray-200 transition duration-200 group-hover:shadow-md group-hover:-translate-y-1" style="background-color: #43B5A0;"></div>
                        <span class="text-xs font-medium text-[#1F2937] text-center">Aqua Green</span>
                    </div>
                    <div class="flex flex-col items-center gap-2 group cursor-pointer">
                        <div class="w-14 h-12 rounded-md shadow-sm border border-gray-200 transition duration-200 group-hover:shadow-md group-hover:-translate-y-1" style="background-color: #C05A3C;"></div>
                        <span class="text-xs font-medium text-[#1F2937] text-center">Terracotta</span>
                    </div>
                    <div class="flex flex-col items-center gap-2 group cursor-pointer">
                        <div class="w-14 h-12 rounded-md shadow-sm border border-gray-200 transition duration-200 group-hover:shadow-md group-hover:-translate-y-1" style="background-color: #222222;"></div>
                        <span class="text-xs font-medium text-[#1F2937] text-center">Black</span>
                    </div>
                    <div class="flex flex-col items-center gap-2 group cursor-pointer">
                        <div class="w-14 h-12 rounded-md shadow-sm border border-gray-200 transition duration-200 group-hover:shadow-md group-hover:-translate-y-1" style="background-color: #888888;"></div>
                        <span class="text-xs font-medium text-[#1F2937] text-center">Grey</span>
                    </div>
                    <div class="flex flex-col items-center gap-2 group cursor-pointer">
                        <div class="w-14 h-12 rounded-md shadow-sm border border-gray-200 transition duration-200 group-hover:shadow-md group-hover:-translate-y-1" style="background-color: #8B5A2B;"></div>
                        <span class="text-xs font-medium text-[#1F2937] text-center">Wood</span>
                    </div>
                    <div class="flex flex-col items-center gap-2 group cursor-pointer">
                        <div class="w-14 h-12 rounded-md shadow-sm border border-gray-200 transition duration-200 group-hover:shadow-md group-hover:-translate-y-1" style="background-color: #F5F5DC;"></div>
                        <span class="text-xs font-medium text-[#1F2937] text-center">Beige</span>
                    </div>
                    <div class="flex flex-col items-center gap-2 group cursor-pointer">
                        <div class="w-14 h-12 rounded-md shadow-sm border border-gray-200 transition duration-200 group-hover:shadow-md group-hover:-translate-y-1" style="background-color: #DF9496;"></div>
                        <span class="text-xs font-medium text-[#1F2937] text-center">Pink</span>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    <div class="bg-brandLightGray border border-gray-200 rounded-lg md:p-6 p-3 text-center flex flex-col items-center justify-center">
                        ...
                        <p class="text-sm text-brandGrayText">
                            Ensure tile joints are clean, dry, and free from dust, grease, and debris.
                        </p>
                    </div>
                    <div class="bg-brandLightGray border border-gray-200 rounded-lg md:p-6 p-3 text-center flex flex-col items-center justify-center">
                        <div class="w-10 h-10 rounded-full bg-brandRed text-white flex items-center justify-center font-bold mb-3 shadow-md">2</div>
                        <h3 class="font-bold text-md mb-1">Mixing Components</h3>
                        <p class="text-sm text-brandGrayText">Mix Part A (Resin) and Part B (Hardener) thoroughly. Then gradually add Part C (Colored Filler Powder) while mixing until a smooth consistency is achieved.</p>
                    </div>
                    <div class="bg-brandLightGray border border-gray-200 rounded-lg md:p-6 p-3 text-center flex flex-col items-center justify-center">
                        <div class="w-10 h-10 rounded-full bg-brandRed text-white flex items-center justify-center font-bold mb-3 shadow-md">3</div>
                        <h3 class="font-bold text-md mb-1">Apply the Grout</h3>
                        <p class="text-sm text-brandGrayText">Spread the grout diagonally across the tile joints using a rubber grout float, ensuring joints are completely filled.</p>
                    </div>
                    <div class="bg-brandLightGray border border-gray-200 rounded-lg md:p-6 p-3 text-center flex flex-col items-center justify-center">
                        ...
                        <p class="text-sm text-brandGrayText">Remove excess grout from tile surfaces using a grout float or sponge.</p>
                    </div>
                    <div class="bg-brandLightGray border border-gray-200 rounded-lg md:p-6 p-3 text-center flex flex-col items-center justify-center">
                        <div class="w-10 h-10 rounded-full bg-brandRed text-white flex items-center justify-center font-bold mb-3 shadow-md">5</div>
                        <h3 class="font-bold text-md mb-1">Cleaning</h3>
                        <p class="text-sm text-brandGrayText">Clean the tile surface with a damp sponge before the grout fully hardens.</p>
                    </div>
                    <div class="bg-brandLightGray border border-gray-200 rounded-lg md:p-6 p-3 text-center flex flex-col items-center justify-center">
                        ...
                        <p class="text-sm text-brandGrayText">Allow the grout to cure properly for maximum strength and durability.</p>
                    </div>
                </div>
            </div>
                    ...
                    <form action="send-mail.php" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="product_name" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm focus:outline-none focus:border-brandRed">
                                ...
                                <option value="epoxy-grout" selected>Epoxy Grout</option>
...
<section class="text-white py-16 relative overflow-hidden bg-cover bg-center"
    ...
    <div class="max-w-4xl mx-auto px-4 relative z-10 text-center">
        ...
        <p class="text-gray-300 mb-8 max-w-2xl mx-auto">Our experts can guide you in selecting the best grout colour and application method for your project.</p>
