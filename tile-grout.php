    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div class="lg:col-span-8">
            ...
            <h1 class="text-3xl md:text-4xl font-bold mb-2">
                Bull Strong
                <span class="text-brandRed"> Tile Grout</span>
            </h1>
            <p class="text-brandGrayText mb-6 text-sm md:text-base md:w-96">
                High Performance Polymer Modified Wall & Floor Tile Grout
            </p>
            ...
            <div class="mb-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-2 p-4 text-md rounded-lg text-brandGrayText bg-[#F3F3F3]">
                    <div class="flex gap-3 p-2">
                        ...
                        <p>Polymer-modified cementitious grout.</p>
                    </div>
                    <div class="flex gap-3 p-2">
                        <i class="fa-regular fa-circle-check text-[#b01620] mt-1"></i>
                        <p>
                            Suitable for wall and floor tile joints.
                        </p>
                    </div>
                    <div class="flex gap-3 p-2">
                        <i class="fa-regular fa-circle-check text-[#b01620] mt-1"></i>
                        <p>
                            Ideal for tile joint widths of 1–3 mm.
                        </p>
                    </div>
                    <div class="flex gap-3 p-2">
                        <i class="fa-regular fa-circle-check text-[#b01620] mt-1"></i>
                        <p>Water resistant and durable grout formulation.</p>
                    </div>
                    <div class="flex gap-3 p-2">
                        <i class="fa-regular fa-circle-check text-[#b01620] mt-1"></i>
                        <p>Provides strong adhesion and crack resistance.</p>
                    </div>
                    <div class="flex gap-3 p-2">
                        <i class="fa-regular fa-circle-check text-[#b01620] mt-1"></i>
                        <p>
                    ...
                    <div class="flex gap-3 p-2">
                        <i class="fa-regular fa-circle-check text-[#b01620] mt-1"></i>
                        <p>
                            Available in multiple colour options to match tiles.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <table class="w-full text-md text-left">
                        ...
                        <tbody class="divide-y divide-gray-200 bg-[#F9F9F9]">
                            <tr class="bg-brandLightGray">
                                ...
                                <td class="px-6 py-4 text-brandGrayText">Polymer Modified Cementitious Tile Grout</td>
                            </tr>
                            <tr class="bg-[#F3F3F3]">
                                <td class="px-6 py-4 font-medium text-brandDark">Joint Width</td>
                                <td class="px-6 py-4 text-brandGrayText">1 – 3 mm</td>
                            </tr>
                            <tr class="bg-brandLightGray">
                                <td class="px-6 py-4 font-medium text-brandDark">Application Areas</td>
                                <td class="px-6 py-4 text-brandGrayText">Wall & Floor Tiles</td>
                            </tr>
                            <tr class="bg-[#F3F3F3]">
                                <td class="px-6 py-4 font-medium text-brandDark">Mixing Ratio</td>
                                <td class="px-6 py-4 text-brandGrayText">300 – 400 ml water per 1 kg grout</td>
                            </tr>
                            <tr class="bg-brandLightGray">
                                <td class="px-6 py-4 font-medium text-brandDark">Admixture Option</td>
                                <td class="px-6 py-4 text-brandGrayText">Can be mixed with Bull Strong Multicrete UP</td>
                            </tr>
                            <tr class="bg-[#F3F3F3]">
                                <td class="px-6 py-4 font-medium text-brandDark">Coverage</td>
                                <td class="px-6 py-4 text-brandGrayText">
                                    Depends on tile size and grout width
                                </td>
                            </tr>
                            <tr class="bg-brandLightGray">
            ...
            <div class="mb-12">
                <div class="flex items-center gap-3 mb-4">
                    <div class="w-6 h-1 bg-[#b01620]"></div>
                    <h2 class="text-2xl font-semibold">Available Colours</h2>
                </div>

                <p class="text-brandGrayText text-sm md:text-base mb-8 max-w-2xl">
                    Bull Strong Tile Grout is available in a range of 10+ attractive colours to match different tile styles.
                </p>

                <div class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-8 xl:grid-cols-10 gap-y-4 md:gap-y-8 gap-x-2 md:gap-x-4">
            ...
            <div class="mb-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-2 p-4 text-md rounded-lg text-brandGrayText bg-white border-2 border-[#F3F3F3]">
                    <div class="flex gap-3 p-2">
                        <i class="fa-regular fa-circle-check text-[#b01620] mt-1"></i>
                        <p>Residential flooring and wall tiling</p>
                    </div>
                    <div class="flex gap-3 p-2">
                        <i class="fa-regular fa-circle-check text-[#b01620] mt-1"></i>
                        <p>
                    ...
                    <div class="flex gap-3 p-2">
                        <i class="fa-regular fa-circle-check text-[#b01620] mt-1"></i>
                        <p>
                            Mosaic and vitrified tile installations
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    <div class="bg-brandLightGray border border-gray-200 rounded-lg p-6 text-center flex flex-col items-center justify-center">
                        ...
                        <p class="text-sm text-brandGrayText">
                            Ensure tile joints are clean, dry, and free from dust, adhesive residue, or debris.
                        </p>
                    </div>
                    <div class="bg-brandLightGray border border-gray-200 rounded-lg p-6 text-center flex flex-col items-center justify-center">
                        ...
                        <p class="text-sm text-brandGrayText">Mix 1 kg of Bull Strong Tile Grout with approximately 300–400 ml of clean water or Bull Strong Multicrete UP admixture until a smooth paste is formed.</p>
                    </div>
                    <div class="bg-brandLightGray border border-gray-200 rounded-lg p-6 text-center flex flex-col items-center justify-center">
                        ...
                        <p class="text-sm text-brandGrayText">Spread the grout diagonally across tile joints using a rubber grout float, ensuring joints are completely filled.</p>
                    </div>
                    <div class="bg-brandLightGray border border-gray-200 rounded-lg p-6 text-center flex flex-col items-center justify-center">
                        ...
                        <p class="text-sm text-brandGrayText">Remove excess grout from the tile surface using the grout float.</p>
                    </div>
                    <div class="bg-brandLightGray border border-gray-200 rounded-lg p-6 text-center flex flex-col items-center justify-center">
                        ...
                        <p class="text-sm text-brandGrayText">Clean the tile surface gently using a damp sponge before the grout sets.</p>
                    </div>
                    <div class="bg-brandLightGray border border-gray-200 rounded-lg p-6 text-center flex flex-col items-center justify-center">
                        ...
                        <p class="text-sm text-brandGrayText">Allow the grout to set and dry completely for strong and durable tile joints.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-12">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <a href="#" class="flex items-center gap-4 p-4 border border-gray-200 rounded-lg hover:shadow-md transition">
                        <i class="fa-regular fa-file-pdf text-3xl text-brandRed"></i>
                        <div>
                            <h4 class="font-bold text-sm text-[#1F2937]">Safety Data Sheet</h4>
...
<section class="text-white py-16 relative overflow-hidden bg-cover bg-center"
    ...
    <div class="max-w-4xl mx-auto px-4 relative z-10 text-center">
        <h2 class="text-3xl md:text-4xl font-bold mb-4">
            Need Help Choosing the Right Grout Colour or Product?
        </h2>
        <p class="text-gray-300 mb-8 max-w-2xl mx-auto">Our experts can guide you in selecting the best grout solution for your tile installation.</p>
